...
contract SupplyChain is Ownable, ConsumerRole, DistributorRole, FarmerRole, RetailerRole {
    ...
    onlyDistributor
  {
    ...
    address payable seller = address(uint160(items[_upc].originFarmerID));
    seller.transfer(items[_upc].productPrice);
  ...
  function purchaseItem(uint _upc) public payable
    ...
    address payable seller = address(uint160(items[_upc].retailerID));
    seller.transfer(items[_upc].productPrice);
